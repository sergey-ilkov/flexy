                ...
                <div class="blog__items">
                    ...
                    <div class="blog__item bg-grd-1">
                        ...
                        <a class="blog__item-link-img" href="{{ route('article', $post->slug) }}">
                            <picture>
                                <source media="(max-width: 600px)" srcset="{{ asset('storage/' . $post->image_min ) }} 600w" />
                                <img class="blog__item-img" src="{{ asset('storage/' . $post->image ) }}" alt="">
                            </picture>
