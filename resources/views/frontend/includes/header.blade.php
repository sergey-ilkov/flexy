            ...
            <nav id="nav-menu" class="nav-menu">
                <ul class="header-menu">
                    <li class="header-menu__item">
                        <a class="header-menu__link {{ active_link('home') }}" href="{{ route('home') }}">Головна</a>
                    </li>
                    <li class="header-menu__item">
                        <a class="header-menu__link {{ active_link('services') }}" href="{{ route('services') }}">Кредитні сервіси</a>
                    </li>
                    <li class="header-menu__item">
                        <a class="header-menu__link {{ active_link('blog') }}" href="{{ route('blog') }}">Блог</a>
                    </li>
                    <li class="header-menu__item">
                        <a class="header-menu__link {{ active_link('about') }}" href="{{ route('about') }}">Про нас</a>
                    </li>
                </ul>
                ...
                <div class="header__buttons">
                    <button class="header-btn header-btn-1 modal-btn" type="button" data-target="sign-up">Зареєструватись</button>
                    <button class="header-btn header-btn-2 modal-btn" type="button" data-target="sign-in">Вхід</button>
                </div>
