    ...
    <div class="modal-body bg-grd-1">
        ...
        <form class="modal-form" action="{{ route('user.register') }}">
            ...
            <div class="modal-form-box">
                ...
                <div class="modal-form-row">
                    <div class="modal-form-group">
                        <label class="modal-form__label" for="date">Дата народження:*</label>
                        <input id="date" class="modal-form__input" type="date" placeholder="31.12.2001" autocomplete="off" name="date">
                ...
                <div class="modal-form-row">
                    <div class="modal-form-group">
                        ...
                        <input id="email" class="modal-form__input" type="email" placeholder="example@gmail.com" autocomplete="off"
                            name="email">
            ...
            <button type="button" class="modal-form__btn btn-1 btn-send">Зареєструватись</button>
